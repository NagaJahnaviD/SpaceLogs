...
export const About =()=>{
    ...
    const backendSkills=["Node.js","MongoDB","SQL","JWT"];
        ...
        <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
                <p className="text-gray-300 mb-6">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam placeat quae deleniti animi facere fuga ut ipsum quia mollitia molestiae.
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                    <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                            ...
                            <ul className="list-disc list-inside text-gray-300 space-y-2">
                                <li>
                                    <strong>Lorem, ipsum dolor.</strong> -Lorem5 srq fgds gfds
                                </li>
                                <li>
                                    Relavent Coursework: Data Structures, Web Application Development
                                </li>
